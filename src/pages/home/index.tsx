      ...
      <section className="relative w-full min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-r from-red-500 to-black text-white">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-12 relative z-10 max-w-[1600px] w-full flex flex-col lg:flex-row items-center justify-between gap-12">
          ...
          <div className="flex-1 text-center lg:text-left">
            ...
            >
              <button className="bg-white text-black font-bold rounded-2xl px-8 sm:px-10 py-3 sm:py-4 text-base sm:text-lg transition-all hover:scale-105 hover:shadow-2xl">
                Get Started Now
              </button>
              <button className="border-2 border-white text-black font-semibold rounded-2xl px-8 sm:px-10 py-3 sm:py-4 hover:bg-white hover:text-black text-base sm:text-lg transition-all hover:scale-105">
                View Services
              </button>
            </div>
          </div>
